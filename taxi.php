          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/t1.jfif" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/t2.jfif" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/t3.jfif" alt="">
              </div>
            </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Taxi</h2>
              <p> A taxi can be used to travel between Jeddah and Madinah at a cost of 400 to 500 Riyals. The journey should take about 3.5 to 4 hours.</p>
